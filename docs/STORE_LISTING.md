...
**Title (29/30):** FX Always: Send Money Smarter

**Short description (77/80):** Compare real transfer costs, get exchange rate alerts, send when it pays off.
...
**Target keywords:** send money, money transfer, remittance, exchange rate alerts, currency converter, transfer fees, travel money
...
**Target keywords:** enviar dinero, remesas, cotización dólar, conversor de monedas, alerta tipo de cambio, comisiones de envío, plata para viajar
...
**Target keywords:** enviar dinheiro, remessa, cotação dólar, conversor de moedas, alerta de câmbio, taxas de remessa, dinheiro para viagem

## Keyword baseline (fill before/after publishing)

Search each term in Play (device in the listing's locale) or use AppTweak free and note FX Always' position.

| Locale | Keyword | Before | After (D+14) |
|---|---|---|---|
| en-US | currency converter | | |
| en-US | exchange rate alerts | | |
| en-US | send money | | |
| en-US | money transfer fees | | |
| es-419 | enviar dinero | | |
| es-419 | remesas | | |
| es-419 | cotización dólar | | |
| es-419 | conversor de monedas | | |
| pt-BR | enviar dinheiro | | |
| pt-BR | remessa | | |
| pt-BR | cotação dólar | | |
