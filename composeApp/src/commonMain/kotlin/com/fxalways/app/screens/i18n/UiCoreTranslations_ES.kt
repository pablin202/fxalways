...
internal val uiTranslationsESCore = mapOf(
        ...
        "Traveler tools, alerts and account" to "Herramientas de viaje, alertas y cuenta",
        "Tipping, cash/card and local prices" to "Propinas, efectivo/tarjeta y precios locales",
        "Market context when you need it" to "Contexto de mercado cuando lo necesitas",
        "know when a rate is worth acting on" to "saber cuándo conviene actuar",
        "track the currencies you care about" to "sigue las monedas que te importan",
        "Account, language, providers and widgets" to "Cuenta, idioma, proveedores y widgets",
        "Unlock OCR, alerts and full provider comparison" to "Desbloquea OCR, alertas y comparación completa",
        "Language" to "Idioma",
        ...
        "TODAY'S MONEY BRIEF" to "BRIEF DE DINERO DE HOY",
        "Travel loop" to "Loop de viaje",
        "Send loop" to "Loop de envío",
        "Income loop" to "Loop de ingresos",
        "Exposure loop" to "Loop de exposición",
        "Savings loop" to "Loop de ahorro",
        "Check the local price before the next payment." to "Chequea el precio local antes del próximo pago.",
        "Compare the route before the next transfer." to "Compara la ruta antes del próximo envío.",
        "Check invoice currency before accepting a rate." to "Revisa la moneda de factura antes de aceptar un rate.",
        "Watch the biggest move before rebalancing." to "Mira el mayor movimiento antes de rebalancear.",
        "Wait for a better window unless the signal improves." to "Espera una mejor ventana salvo que la señal mejore.",
        "Watch" to "Mirar",
        "Proof" to "Prueba",
        "saved" to "ahorrado",
        "bad spread" to "mal spread",
        "profile pair" to "par del perfil",
        "Why come back" to "Por qué volver",
        "Alert watching" to "Alerta mirando",
        "Alert paused" to "Alerta pausada",
        "Pro alert needed" to "Alerta Pro requerida",
        "No alert yet" to "Sin alerta aún",
        "Rates, OCR and alerts tell you when card or cash is safer." to "Rates, OCR y alertas te dicen cuándo tarjeta o efectivo es más seguro.",
        "Provider fees move enough that the best route can change before payday." to "Los fees de proveedores se mueven lo suficiente para cambiar la mejor ruta antes del cobro.",
        "Small spreads compound across repeat invoices and withdrawals." to "Spreads pequeños se acumulan en facturas y retiros repetidos.",
        "Daily movement and stablecoin exposure are easier to act on together." to "Movimiento diario y exposición stablecoin son más accionables juntos.",
        "Alerts and long-range context reduce unnecessary conversions." to "Alertas y contexto de largo plazo reducen conversiones innecesarias.",
        "Open traveler tools" to "Abrir herramientas de viaje",
        "Compare route" to "Comparar ruta",
        "Check invoice" to "Revisar factura",
        "Open watchlist" to "Abrir watchlist",
        "Review allocation" to "Revisar allocation",
        "Set alert" to "Crear alerta",
        "Reason: portfolio impact" to "Razón: impacto en portfolio",
        "Reason: create an alert or amount next" to "Razón: crear alerta o monto luego",
        "Reason: travel, income or savings" to "Razón: viaje, ingresos o ahorro",
        "Reason: volatility and allocation" to "Razón: volatilidad y allocation",
        "Reason: today's action trigger" to "Razón: trigger de acción de hoy",
    )
