...
class PaywallScreenTest {
    ...
    fun freePaywallShowsConcreteFreeVsProValueAndStartsSelectedPlan() {
        ...
        compose.onNodeWithText("2 active alerts").performScrollTo().assertIsDisplayed()
        compose.onNodeWithText("Unlimited + best-moment and cheapest-provider alerts").performScrollTo().assertIsDisplayed()
